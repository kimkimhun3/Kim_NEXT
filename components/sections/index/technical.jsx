			...
			<Container spacing={['verticalXXXLrg']}>
				...
				<section className={`${about.content} ${about.container}`}>
					...
					<div className={`${about.image} ${about.technicalSvg}`}>
						<Image src="/img/b.svg" width={2000} height={2000} alt="Data Strings 01 by Colorpong: https://ywft.us/2177b695b" />
					</div>
				</section>	
			</Container>
			<SectionGridBg gridSize={10}/>
		</Section>
	)
}

const software = [
	{ key: 'bash', 	name: 'Nvidia', 			type: 'devicon' },
...
const tech	= [
	...
	{ key: 'bash', 		name: 'Bash Script', 			type: 'devicon' },
