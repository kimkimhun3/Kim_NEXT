	...
	return (
		<Section classProp={`${looking.section} borderBottom`}>	
			<Container classProp={`${section.title} ${looking.container}`} spacing={['verticalXXXLrg']}>
				...
				<h4>Massive shoutout to my leader, senpai, and team member for teaching me since the jump in the realm of video encoding technology. Your guidance has been absolutely stellar!  🎥🚀</h4>
